...
public class MoviesList {
	...
	static String MovieClass;
	static String PastReviews;
	static String OverallRating;
	static String ShowStart;
	static String EndOfShowing;
	static String TotalSales;
	static int i;
	static String collectNewMovie;
	static String collectAll;
	static List <String> newmovie = new ArrayList <String>();
	static List<String> movieListings = new ArrayList<String>();
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 'A':
				...
				WriteFile.writeFile(collectAll, movieFile);
				break;
			case 'b':
			case 'B':
				int count = 0;
				...
				for (int k=0;k<count;k++) {
					if (listoflists.get(k).get(0).contains(moviechoice)) {
						...
						WriteFile.writeFile(collectmovies, movieFile);
					}
				}
			} 
		} while (i != -1);
